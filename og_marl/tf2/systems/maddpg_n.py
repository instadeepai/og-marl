...
class MADDPGSystem(BaseMARLSystem):
    ...
    def __init__(
        ...
        self._critic_network_3 = copy.deepcopy(self._critic_network_1)
        self._critic_network_4 = copy.deepcopy(self._critic_network_1)
        self._critic_network_5 = copy.deepcopy(self._critic_network_1)
        ...
        self._target_critic_network_3 = copy.deepcopy(self._critic_network_1)
        self._target_critic_network_4 = copy.deepcopy(self._critic_network_1)
        self._target_critic_network_5 = copy.deepcopy(self._critic_network_1)
    ...
    def _tf_train_step(self, experience: Dict[str, Any]) -> Dict[str, Numeric]:
        ...
        target_qs_3 = self._target_critic_network_3(env_states, target_actions, target_actions)
        target_qs_4 = self._target_critic_network_4(env_states, target_actions, target_actions)
        target_qs_5 = self._target_critic_network_5(env_states, target_actions, target_actions)

        # Take minimum between two target critics
        target_qs = tf.reduce_min((target_qs_1, target_qs_2, target_qs_3, target_qs_4, target_qs_5), axis=0)
        ...
        with tf.GradientTape(persistent=True) as tape:
            ...
            qs_3 = tf.squeeze(
                self._critic_network_3(env_states, replay_actions, replay_actions),
                axis=-1,
            )
            qs_4 = tf.squeeze(
                self._critic_network_4(env_states, replay_actions, replay_actions),
                axis=-1,
            )
            qs_5 = tf.squeeze(
                self._critic_network_5(env_states, replay_actions, replay_actions),
                axis=-1,
            )
            ...
            critic_loss_3 = tf.reduce_mean(0.5 * (targets - qs_3[:-1]) ** 2)
            critic_loss_4 = tf.reduce_mean(0.5 * (targets - qs_4[:-1]) ** 2)
            critic_loss_5 = tf.reduce_mean(0.5 * (targets - qs_5[:-1]) ** 2)
            critic_loss = (critic_loss_1 + critic_loss_2 + critic_loss_3 + critic_loss_4 + critic_loss_5) / 5
            ...
            qs_3 = self._critic_network_3(env_states, online_actions, tf.stop_gradient(online_actions))
            qs_4 = self._critic_network_4(env_states, online_actions, tf.stop_gradient(online_actions))
            qs_5 = self._critic_network_5(env_states, online_actions, tf.stop_gradient(online_actions))
            qs = tf.reduce_min((qs_1, qs_2, qs_3, qs_4, qs_5), axis=0)
        ...
        variables = (
            ...
            *self._critic_network_3.trainable_variables,
            *self._critic_network_4.trainable_variables,
            *self._critic_network_5.trainable_variables,
        )
        ...
        online_variables = (
            ...
            *self._critic_network_3.variables,
            *self._critic_network_4.variables,
            *self._critic_network_5.variables,
            *self._policy_network.variables,
        )
        target_variables = (
            *self._target_critic_network_1.variables,
            *self._target_critic_network_2.variables,
            *self._target_critic_network_3.variables,
            *self._target_critic_network_4.variables,
            *self._target_critic_network_5.variables,

...
"""Implementation of Independent Q-Learning (IQL)"""
...
class IQLSystem(BaseOnlineSystem):
...
@hydra.main(version_base=None, config_path="configs", config_name="iql")
def run_experiment(cfg: DictConfig) -> None:
    ...
    system = IQLSystem(env, eval_env, logger, **cfg["system"])

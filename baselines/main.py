...
flags.DEFINE_string("dataset", "medium_replay", "Dataset type.: 'Good', 'Medium', 'Poor' or 'Replay' ")
...
def main(_):
    ...
    is_vault_loaded = buffer.populate_from_vault(FLAGS.env, FLAGS.scenario, "medium_replay")#FLAGS.dataset)

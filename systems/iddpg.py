...
from utils.utils import (
    ...
    concat_agent_id_to_back_of_obs,
...
class IDDPGSystem(BaseMARLSystem):
    ...
    def __init__(
        ...
        is_omiga: bool = False # for OMIGA datasets only
    ):
        super().__init__(
            environment, logger, add_agent_id_to_obs_in_trainer=add_agent_id_to_obs_in_trainer, add_agent_id_to_obs_in_action_selection=add_agent_id_to_obs_in_action_selection, discount=discount
        )
    ...
    def _tf_select_actions(
        ...
        for i, agent in enumerate(self._environment.possible_agents):
            ...
            if self._is_omiga:
                agent_observation = concat_agent_id_to_back_of_obs(
            ...
            elif self._add_agent_id_to_obs_in_action_selection: 
